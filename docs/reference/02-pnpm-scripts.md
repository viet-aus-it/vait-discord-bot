...
| Script                 | Description                                                                              |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| `pnpm lint`            | Check for linting issues with [Oxlint](https://oxc.rs/docs/guide/usage/linter)           |
| `pnpm lint:fix`        | Auto-fix linting issues with [Oxlint](https://oxc.rs/docs/guide/usage/linter)            |
| `pnpm lint:fix:unsafe` | Auto-fix linting issues with [Oxlint](https://oxc.rs/docs/guide/usage/linter)            |
| `pnpm format`          | Format code with [Oxfmt](https://oxc.rs/docs/guide/usage/formatter) and Prisma formatter |
