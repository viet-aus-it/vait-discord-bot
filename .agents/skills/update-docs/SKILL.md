...
- **`reference/`**: `01-commands-list`, `02-pnpm-scripts`, `03-project-structure`, `04-database-schema`, `05-environment-variables`, `06-command-interfaces`, `07-testing-utilities`, `08-error-handling`, `09-telemetry`
