...
if [[ $NODE_VER != *"16"* ]] || [[ $PNPM_VER != *"8"* ]]; then
  echo "Please ensure you are using the correct version of Node (v16) and/or PNPM (v8) or else you cannot install the dependencies."
else
